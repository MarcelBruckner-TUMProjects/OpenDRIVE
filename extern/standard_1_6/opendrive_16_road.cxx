...
namespace simulation
{
  namespace standard
  {
    namespace opendrive_schema
    {
      ...
      _xsd_e_countryCode_deprecated_indexes_[9] =
      {
        ::simulation::standard::opendrive_schema::e_countryCode_deprecated::Austria,
        ::simulation::standard::opendrive_schema::e_countryCode_deprecated::Brazil,
        ::simulation::standard::opendrive_schema::e_countryCode_deprecated::China,
        ::simulation::standard::opendrive_schema::e_countryCode_deprecated::France,
        ::simulation::standard::opendrive_schema::e_countryCode_deprecated::Germany,
        ::simulation::standard::opendrive_schema::e_countryCode_deprecated::Italy,
        ::simulation::standard::opendrive_schema::e_countryCode_deprecated::OpenDRIVE,
        ::simulation::standard::opendrive_schema::e_countryCode_deprecated::Switzerland,
        ::simulation::standard::opendrive_schema::e_countryCode_deprecated::USA
      };
      ...
      _xsd_e_direction_indexes_[2] =
      {
        ::simulation::standard::opendrive_schema::e_direction::opposite,
        ::simulation::standard::opendrive_schema::e_direction::same
      };
      ...
      _xsd_e_maxSpeedString_indexes_[2] =
      {
        ::simulation::standard::opendrive_schema::e_maxSpeedString::no_limit,
        ::simulation::standard::opendrive_schema::e_maxSpeedString::undefined
      };
      ...
      _xsd_e_paramPoly3_pRange_indexes_[2] =
      {
        ::simulation::standard::opendrive_schema::e_paramPoly3_pRange::arcLength,
        ::simulation::standard::opendrive_schema::e_paramPoly3_pRange::normalized
      };
      ...
      _xsd_e_road_link_elementType_indexes_[2] =
      {
        ::simulation::standard::opendrive_schema::e_road_link_elementType::junction,
        ::simulation::standard::opendrive_schema::e_road_link_elementType::road
      };
      ...
      _xsd_e_roadType_indexes_[13] =
      {
        ::simulation::standard::opendrive_schema::e_roadType::bicycle,
        ::simulation::standard::opendrive_schema::e_roadType::lowSpeed,
        ::simulation::standard::opendrive_schema::e_roadType::motorway,
        ::simulation::standard::opendrive_schema::e_roadType::pedestrian,
        ::simulation::standard::opendrive_schema::e_roadType::rural,
        ::simulation::standard::opendrive_schema::e_roadType::town,
        ::simulation::standard::opendrive_schema::e_roadType::townArterial,
        ::simulation::standard::opendrive_schema::e_roadType::townCollector,
        ::simulation::standard::opendrive_schema::e_roadType::townExpressway,
        ::simulation::standard::opendrive_schema::e_roadType::townLocal,
        ::simulation::standard::opendrive_schema::e_roadType::townPlayStreet,
        ::simulation::standard::opendrive_schema::e_roadType::townPrivate,
        ::simulation::standard::opendrive_schema::e_roadType::unknown
      };
      ...
      _xsd_e_trafficRule_indexes_[2] =
      {
        ::simulation::standard::opendrive_schema::e_trafficRule::LHT,
        ::simulation::standard::opendrive_schema::e_trafficRule::RHT
      };
             ...
             ::xml_schema::flags f)
      {
        for (; p.more_content (); p.next_content (false))
        {
          ...
          // planView
          //
          if (n.name () == "planView" && n.namespace_ () == "http://code.asam.net/simulation/standard/opendrive_schema")
          {
          ...
          // elevationProfile
          //
          if (n.name () == "elevationProfile" && n.namespace_ () == "http://code.asam.net/simulation/standard/opendrive_schema")
          {
          ...
          // lateralProfile
          //
          if (n.name () == "lateralProfile" && n.namespace_ () == "http://code.asam.net/simulation/standard/opendrive_schema")
          {
          ...
          // lanes
          //
          if (n.name () == "lanes" && n.namespace_ () == "http://code.asam.net/simulation/standard/opendrive_schema")
          {
          ...
          // objects
          //
          if (n.name () == "objects" && n.namespace_ () == "http://code.asam.net/simulation/standard/opendrive_schema")
          {
          ...
          // signals
          //
          if (n.name () == "signals" && n.namespace_ () == "http://code.asam.net/simulation/standard/opendrive_schema")
          {
          ...
          // railroad
          //
          if (n.name () == "railroad" && n.namespace_ () == "http://code.asam.net/simulation/standard/opendrive_schema")
          {
             ...
             ::xml_schema::flags f)
      {
        for (; p.more_content (); p.next_content (false))
        {
          ...
          // elevation
          //
          if (n.name () == "elevation" && n.namespace_ () == "http://code.asam.net/simulation/standard/opendrive_schema")
          {
             ...
             ::xml_schema::flags f)
      {
        for (; p.more_content (); p.next_content (false))
        {
          ...
          // superelevation
          //
          if (n.name () == "superelevation" && n.namespace_ () == "http://code.asam.net/simulation/standard/opendrive_schema")
          {
          ...
          // shape
          //
          if (n.name () == "shape" && n.namespace_ () == "http://code.asam.net/simulation/standard/opendrive_schema")
          {
             ...
             ::xml_schema::flags f)
      {
        for (; p.more_content (); p.next_content (false))
        {
          ...
          // geometry
          //
          if (n.name () == "geometry" && n.namespace_ () == "http://code.asam.net/simulation/standard/opendrive_schema")
          {
             ...
             ::xml_schema::flags f)
      {
        for (; p.more_content (); p.next_content (false))
        {
          ...
          // spiral
          //
          if (n.name () == "spiral" && n.namespace_ () == "http://code.asam.net/simulation/standard/opendrive_schema")
          {
          ...
          // arc
          //
          if (n.name () == "arc" && n.namespace_ () == "http://code.asam.net/simulation/standard/opendrive_schema")
          {
          ...
          // poly3
          //
          if (n.name () == "poly3" && n.namespace_ () == "http://code.asam.net/simulation/standard/opendrive_schema")
          {
          ...
          // paramPoly3
          //
          if (n.name () == "paramPoly3" && n.namespace_ () == "http://code.asam.net/simulation/standard/opendrive_schema")
          {
      ...
      t_road_planView_geometry_line (const ::xercesc::DOMElement& e,
                                     ::xml_schema::flags f,
                                     ::xml_schema::container* c)
      : ::simulation::standard::opendrive_schema::_OpenDriveElement (e, f, c)
      {
      }
      ...
      t_road_planView_geometry_line (const ::xercesc::DOMAttr& a,
                                     ::xml_schema::flags f,
                                     ::xml_schema::container* c)
      : ::simulation::standard::opendrive_schema::_OpenDriveElement (a, f, c)
      {
      }
      ...
      t_road_planView_geometry_line (const ::std::string& s,
                                     ...
                                     ::xml_schema::flags f,
                                     ::xml_schema::container* c)
      : ::simulation::standard::opendrive_schema::_OpenDriveElement (s, e, f, c)
      {
      }
