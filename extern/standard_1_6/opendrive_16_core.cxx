...
namespace simulation
{
  namespace standard
  {
    namespace opendrive_schema
    {
      ...
      _xsd_e_dataQuality_RawData_PostProcessing_indexes_[4] =
      {
        ::simulation::standard::opendrive_schema::e_dataQuality_RawData_PostProcessing::cleaned,
        ::simulation::standard::opendrive_schema::e_dataQuality_RawData_PostProcessing::fused,
        ::simulation::standard::opendrive_schema::e_dataQuality_RawData_PostProcessing::processed,
        ::simulation::standard::opendrive_schema::e_dataQuality_RawData_PostProcessing::raw
      };
      ...
      _xsd_e_dataQuality_RawData_Source_indexes_[3] =
      {
        ::simulation::standard::opendrive_schema::e_dataQuality_RawData_Source::cadaster,
        ::simulation::standard::opendrive_schema::e_dataQuality_RawData_Source::custom,
        ::simulation::standard::opendrive_schema::e_dataQuality_RawData_Source::sensor
      };
      ...
      _xsd_e_unit_indexes_[10] =
      {
        ::simulation::standard::opendrive_schema::e_unit::cxx_,
        ::simulation::standard::opendrive_schema::e_unit::ft,
        ::simulation::standard::opendrive_schema::e_unit::kg,
        ::simulation::standard::opendrive_schema::e_unit::km,
        ::simulation::standard::opendrive_schema::e_unit::km_h,
        ::simulation::standard::opendrive_schema::e_unit::m,
        ::simulation::standard::opendrive_schema::e_unit::m_s,
        ::simulation::standard::opendrive_schema::e_unit::mile,
        ::simulation::standard::opendrive_schema::e_unit::mph,
        ::simulation::standard::opendrive_schema::e_unit::t
      };
      ...
      _xsd_e_unitDistance_indexes_[4] =
      {
        ::simulation::standard::opendrive_schema::e_unitDistance::ft,
        ::simulation::standard::opendrive_schema::e_unitDistance::km,
        ::simulation::standard::opendrive_schema::e_unitDistance::m,
        ::simulation::standard::opendrive_schema::e_unitDistance::mile
      };
      ...
      _xsd_e_unitMass_indexes_[2] =
      {
        ::simulation::standard::opendrive_schema::e_unitMass::kg,
        ::simulation::standard::opendrive_schema::e_unitMass::t
      };
      ...
      _xsd_e_unitSlope_indexes_[1] =
      {
        ::simulation::standard::opendrive_schema::e_unitSlope::cxx_
      };
      ...
      _xsd_e_unitSpeed_indexes_[3] =
      {
        ::simulation::standard::opendrive_schema::e_unitSpeed::km_h,
        ::simulation::standard::opendrive_schema::e_unitSpeed::m_s,
        ::simulation::standard::opendrive_schema::e_unitSpeed::mph
      };
      ...
      _xsd_t_yesNo_indexes_[2] =
      {
        ::simulation::standard::opendrive_schema::t_yesNo::no,
        ::simulation::standard::opendrive_schema::t_yesNo::yes
      };
             ...
             ::xml_schema::flags f)
      {
        for (; p.more_content (); p.next_content (false))
        {
          ...
          // error
          //
          if (n.name () == "error" && n.namespace_ () == "http://code.asam.net/simulation/standard/opendrive_schema")
          {
          ...
          // rawData
          //
          if (n.name () == "rawData" && n.namespace_ () == "http://code.asam.net/simulation/standard/opendrive_schema")
          {
             ...
             ::xml_schema::flags f)
      {
        for (; p.more_content (); p.next_content (false))
        {
          ...
          // geoReference
          //
          if (n.name () == "geoReference" && n.namespace_ () == "http://code.asam.net/simulation/standard/opendrive_schema")
          {
          ...
          // offset
          //
          if (n.name () == "offset" && n.namespace_ () == "http://code.asam.net/simulation/standard/opendrive_schema")
          {
             ...
             ::xml_schema::flags f)
      {
        for (; p.more_content (); p.next_content (false))
        {
          ...
          // header
          //
          if (n.name () == "header" && n.namespace_ () == "http://code.asam.net/simulation/standard/opendrive_schema")
          {
          ...
          // road
          //
          if (n.name () == "road" && n.namespace_ () == "http://code.asam.net/simulation/standard/opendrive_schema")
          {
          ...
          // junction
          //
          if (n.name () == "junction" && n.namespace_ () == "http://code.asam.net/simulation/standard/opendrive_schema")
          {
          ...
          // junctionGroup
          //
          if (n.name () == "junctionGroup" && n.namespace_ () == "http://code.asam.net/simulation/standard/opendrive_schema")
          {
          ...
          // station
          //
          if (n.name () == "station" && n.namespace_ () == "http://code.asam.net/simulation/standard/opendrive_schema")
          {
...
namespace simulation
{
  namespace standard
  {
    namespace opendrive_schema
    {
      ::std::unique_ptr< ::simulation::standard::opendrive_schema::OpenDRIVE >
                  ...
                  const ::xml_schema::properties& p)
      {
        ...
        return ::std::unique_ptr< ::simulation::standard::opendrive_schema::OpenDRIVE > (
          ::simulation::standard::opendrive_schema::OpenDRIVE_ (
                  ...
                  const ::xml_schema::properties& p)
      {
        ...
        return ::simulation::standard::opendrive_schema::OpenDRIVE_ (isrc, f, p);
      }
                  ...
                  const ::xml_schema::properties& p)
      {
        ...
        ::xsd::cxx::xml::sax::std_input_source isrc (is);
        return ::simulation::standard::opendrive_schema::OpenDRIVE_ (isrc, h, f, p);
      }
                  ...
                  const ::xml_schema::properties& p)
      {
        ...
        if (n.name () == "OpenDRIVE" &&
            n.namespace_ () == "http://code.asam.net/simulation/standard/opendrive_schema")
        {
          ::std::unique_ptr< ::simulation::standard::opendrive_schema::OpenDRIVE > r (
            ::xsd::cxx::tree::traits< ::simulation::standard::opendrive_schema::OpenDRIVE, char >::create (
              e, f, 0));
          return r;
        }
